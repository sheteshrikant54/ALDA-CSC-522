...
vectorizer = TfidfVectorizer(max_features=3000,use_idf=True,max_df=0.9,min_df=0.1)
...
clf = svm.LinearSVC(dual=False).fit(train_data_features,train["category"])
...
output.to_csv( "D:/MS/ALDA CSC 522/Project/SVMIDFPrediction.csv", index=False, quoting=3 )